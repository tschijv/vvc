...
async function generate() {
    ...
    sections: [{
      ...
      headers: {
        default: new Header({ children: [new Paragraph({
          ...
          children: [new TextRun({ text: "Advies Voorzieningencatalogus v3.0 \u2014 Vertrouwelijk", font: "Arial", size: 16, color: GRAY })],
        })] }),
      },
      footers: {
      ...
      children: [
        ...
        spacer(200),
        new Paragraph({ spacing: { after: 40 }, children: [new TextRun({ text: "Versie 3.0 \u2014 Herzien na doorontwikkeling", font: "Arial", size: 22, color: GRAY, italics: true })] }),
        spacer(400),
        makeTable(["", ""], [
        ...
        makeTable(["Categorie", "Onderdelen", "Aantal"], [
          ...
          ["Documentatie", "Demo draaiboek (22 secties), PvE-analyse, Datamodel (MIM), Handleidingen, Regeneratie-prompt", "5"],
        ], [1800, 5426, 800]),
        spacer(80),
        pitalic("Totaal: 88 routes, 24+ datamodellen, 26 Playwright tests, 15+ API endpoints."),
        ...
        bullet("@ts-nocheck op de grootste pagina (gemeente detail) \u2014 typefouten worden niet afgevangen"),
        ...
        bullet("Geen unit tests \u2014 0% unit test coverage"),
        ...
        bullet("Geen accessibility audit (WCAG 2.1 AA) \u2014 wettelijk verplicht voor overheidswebsites"),
        ...
        bullet("QR-codes worden gegenereerd via externe API (qrserver.com) \u2014 data lekt naar derden"),
        bullet("Geen input sanitization op alle formulieren \u2014 XSS-vectoren mogelijk"),
        ...
        makeTable(["#", "Risico", "Impact", "Kans", "Mitigatie"], [
          ...
          [{ text: "R6", bold: true }, "WCAG-overtreding (wettelijke verplichting)", "Medium", { text: "Hoog", color: RED, bold: true, bg: LIGHT_RED }, "Externe WCAG-audit en fixes"],
          [{ text: "R7", bold: true }, "Regressie door ontbreken tests bij doorontwikkeling", "Medium", { text: "Hoog", color: RED, bold: true, bg: LIGHT_RED }, "Testsuite uitbreiden (>70% coverage)"],
        ...
        makeTable(["Prio", "Onderdeel", "Toelichting", "Risico bij weglaten"], [
          ...
          [{ text: "P2", bold: true, bg: ORANGE_BG }, "WCAG-audit (extern)", "Wettelijk verplicht, WCAG 2.1 AA", "R6: Wettelijk risico"],
  ...
  fs.writeFileSync("/Users/toineschijvenaars/claude/vvc/docs/Advies Voorzieningencatalogus v3.docx", buffer);
  console.log("Document gegenereerd: docs/Advies Voorzieningencatalogus v3.docx");
}
