  ...
  const doc = new Document({
    ...
    sections: [{
      ...
      children: [
        ...
        bullet("@ts-nocheck op enkele grote pagina\u2019s \u2014 wordt geleidelijk opgelost (was gemeente detail, nu gedeeltelijk gefixed)"),
