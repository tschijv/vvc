...
export const sections: PveSection[] = [
  ...
  },
  {
    ...
    subtitle: "22 bevindingen — 3 critical, 6 high, 8 medium, 5 low",
    rows: [
      { id: "CVE-001", naam: "Auth ontbreekt op admin user routes", prio: "eis", status: "no", toelichting: "CRITICAL: /api/admin/users/ heeft geen auth check. Iedereen kan admin-accounts aanmaken, rollen wijzigen of users verwijderen." },
      { id: "CVE-002", naam: "Auth ontbreekt op CSV export routes", prio: "eis", status: "no", toelichting: "CRITICAL: 4 export routes lekken PII (contactpersonen, emails) van 342 gemeenten zonder authenticatie." },
      { id: "CVE-003", naam: "Auth ontbreekt op addenda export", prio: "eis", status: "no", toelichting: "HIGH: Addenda export lekt contractdata (deadlines, ondertekeningsdatums) zonder authenticatie." },
      { id: "CVE-004", naam: "XSS via AI-adviseur (geen DOMPurify)", prio: "eis", status: "no", toelichting: "HIGH: dangerouslySetInnerHTML zonder sanitisatie. Prompt injection → JavaScript executie in browser." },
      { id: "CVE-005", naam: "XSS via GlossaryHighlighter", prio: "eis", status: "no", toelichting: "HIGH: HTML prop niet gesanitized. Externe SKOSMOS API data → XSS vector." },
      { id: "CVE-006", naam: "XSS via SVG KaartViewer", prio: "eis", status: "no", toelichting: "HIGH: SVG content via dangerouslySetInnerHTML. SVG kan <script> tags bevatten." },
      { id: "CVE-007", naam: "Geen ownership check addendum updates", prio: "eis", status: "no", toelichting: "HIGH: Leverancier kan addenda van andere leveranciers wijzigen." },
      { id: "CVE-008", naam: "Error messages lekken interne details", prio: "eis", status: "no", toelichting: "HIGH: error.message naar client in 7+ API routes. Lekt database schema, Prisma errors." },
      { id: "CVE-009", naam: "2FA bypass voor admin accounts", prio: "eis", status: "no", toelichting: "HIGH: Admins expliciet uitgesloten van TOTP verificatie. Hoogste privileges, minste bescherming." },
      { id: "CVE-010", naam: "In-memory rate limiting nutteloos op serverless", prio: "wens", status: "no", toelichting: "MEDIUM: Rate limiter Map leeft per instance. Op Vercel serverless triviaal te bypassen." },
      { id: "CVE-011", naam: "Open redirect via callbackUrl", prio: "eis", status: "no", toelichting: "MEDIUM: Login redirect via ?callbackUrl= zonder validatie. Phishing vector." },
      { id: "CVE-012", naam: "Rate limiting ontbreekt op 53/65 routes", prio: "wens", status: "no", toelichting: "MEDIUM: Alleen 12 van 65 API routes hebben withRateLimit. Auth routes onbeschermd." },
      { id: "CVE-013", naam: "Geen file size limit op uploads", prio: "eis", status: "no", toelichting: "MEDIUM: Upload service leest hele file in geheugen zonder size check. DoS vector." },
      { id: "CVE-014", naam: "Geen MIME type validatie uploads", prio: "wens", status: "no", toelichting: "MEDIUM: Alleen extensie-check, geen MIME type validatie." },
      { id: "CVE-015", naam: "CSV injection in exports", prio: "wens", status: "no", toelichting: "MEDIUM: Data met =,+,-,@ prefix wordt als Excel formule geïnterpreteerd." },
      { id: "CVE-016", naam: "Timing-unsafe Basic Auth", prio: "wens", status: "no", toelichting: "MEDIUM: === vergelijking i.p.v. crypto.timingSafeEqual(). Timing attack mogelijk." },
      { id: "CVE-017", naam: "Middleware sluit API uit van Basic Auth", prio: "wens", status: "no", toelichting: "MEDIUM: API routes niet beschermd door Basic Auth laag. Versterkt CVE-001." },
      { id: "CVE-018", naam: "CORS wildcard op RDF endpoints", prio: "wens", status: "nvt", toelichting: "LOW: Access-Control-Allow-Origin: * op publieke Linked Data endpoints. Geaccepteerd risico." },
      { id: "CVE-019", naam: "Silently swallowed errors", prio: "wens", status: "no", toelichting: "LOW: .catch(() => {}) bij login timestamp update. Audit trail onvolledig." },
      { id: "CVE-020", naam: "Kwetsbare transitive dependencies", prio: "wens", status: "no", toelichting: "LOW: hono, lodash, effect via Prisma. Niet direct runtime risico." },
      { id: "CVE-021", naam: "Ontbrekende audit logging", prio: "wens", status: "no", toelichting: "LOW: Profiel, favorieten, notificaties, user management niet geaudit." },
      { id: "CVE-022", naam: "Security headers ontbreken in middleware", prio: "eis", status: "no", toelichting: "LOW: CSP, X-Frame-Options etc. niet in middleware geconfigureerd ondanks claim in docs." },
    ],
  },
];
