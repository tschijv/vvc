...
const sources: CsvSource[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { csv: "Pakket aantal gemeenten", prisma: "Pakket.aantalOrganisaties", type: "String → Int" },
      ...
      { csv: "Pakketversie aantal gemeenten", prisma: "Pakketversie.aantalOrganisaties", type: "String → Int" },
