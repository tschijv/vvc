...
export default async function InkoopPage() {
  ...
  return (
    <div>
      ...
      <InkoopClient referentiecomponenten={referentiecomponenten} tenantNaam={tenant.naam} />
    </div>
  );
}
