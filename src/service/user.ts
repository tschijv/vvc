...
export async function approveRegistration(
  ...
  const { sendEmail } = await import("@/integration/email");
  const { registratieGoedgekeurdEmail } = await import("@/integration/email-templates");
...
export async function rejectRegistration(id: string, reden?: string) {
  ...
  const { sendEmail } = await import("@/integration/email");
  const { registratieAfgewezenEmail } = await import("@/integration/email-templates");
