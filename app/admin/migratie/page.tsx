...
const sources: CsvSource[] = [
  ...
  },
  {
    ...
    delimiter: ";",
    encoding: "UTF-8",
    entities: ["Pakket", "Pakketversie", "PakketversieReferentiecomponent", "PakketversieStandaard", "PakketversieTechnologie"],
    color: "blue",
    columns: [
      ...
      { csv: "Referentiecomponenten leverancier", prisma: "PakketversieReferentiecomponent (type=leverancier)", type: "Multi-value", notes: "Comma-separated namen. Match op Referentiecomponent.naam" },
      { csv: "Referentiecomponenten leverancier UUID", prisma: "PakketversieReferentiecomponent.referentiecomponentId", type: "Multi-value UUIDs", notes: "Comma-separated UUIDs, 1-op-1 met namen" },
      { csv: "Referentiecomponenten gemeente", prisma: "PakketversieReferentiecomponent (type=gemeente)", type: "Multi-value", notes: "Idem, maar type=gemeente" },
      { csv: "Referentiecomponenten gemeente UUID", prisma: "PakketversieReferentiecomponent.referentiecomponentId", type: "Multi-value UUIDs" },
      ...
      { csv: "Pakketversie Ondersteunde technologieën", prisma: "PakketversieTechnologie.technologie", type: "Multi-value", notes: "Comma-separated. Per waarde een PakketversieTechnologie record" },
      { csv: "Ondersteuning standaardversies", prisma: "PakketversieStandaard", type: "Multi-value", notes: "Comma-separated standaardversie-namen. Match op Standaardversie.naam" },
  ...
  },
  {
    ...
    delimiter: ";",
    encoding: "UTF-8",
    entities: ["Gemeente", "Samenwerking", "SamenwerkingGemeente", "GemeentePakket", "PakketversieReferentiecomponent"],
    color: "green",
    columns: [
      ...
      { csv: "Referentiecomponenten ID", prisma: "PakketversieReferentiecomponent", type: "UUID", notes: "Gemeente-perspectief referentiecomponenten" },
...
const importOrder = [
  ...
  { stap: 5, entiteit: "PakketversieReferentiecomponent", bron: "leveranciers_pakketten_*.csv", notes: "Na stap 1 + 4, match op UUID" },
  { stap: 6, entiteit: "PakketversieStandaard", bron: "leveranciers_pakketten_*.csv", notes: "Na stap 2 + 4, match op naam" },
  { stap: 7, entiteit: "PakketversieTechnologie", bron: "leveranciers_pakketten_*.csv", notes: "Na stap 4" },
